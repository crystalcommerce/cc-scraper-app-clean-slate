...
const { getAll, getOneById, getOneByFilter, getAllFiltered, create, update, deleteById } = tcgPlayerFleshAndBloodControllers(tcgPlayerFleshAndBloodsDb, "Flesh And Blood");
